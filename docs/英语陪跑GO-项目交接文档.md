...
> **当前版本补充（2026-09-19）**：测评重构、购买页手机/PC适配、工具规划和浏览器自测见 [`EPGO_入学测评与交接说明.md`](EPGO_入学测评与交接说明.md)。当前开放 KET 29 题，PET/FCE 因材料缺失保留为待校对草稿；购买页微信支付、订单和账号开通脚本保持原样。本文后面关于“支付后自动分配库存账号”的内容属于历史流程；修改前必须核对当前代码和供应商实际开通方式。
