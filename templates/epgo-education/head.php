...
<nav class="met-head navbar navbar-expand-md navbar-light">
    <div class="container">
        ...
        <a class="navbar-brand" href="{$c.index_url}">
            <if value="$c['met_logo']">
                <img src="{$c.met_logo}" alt="{$c.met_webname}" style="max-height: 40px;">
            <else/>
                <span style="font-size:20px;font-weight:700;color:var(--color-primary);">{$c.met_webname}</span>
            </if>
        </a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="javascript:void(0)" class="nav-link" onclick="epgoEducation.showQRCode()">
                        <i class="icon wb-wechat"></i> {$word.wechat}
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="qrcode-modal-body">
            ...
            <div class="qrcode-box">
                <if value="$lang['footinfo_wx']">
                    <img src="{$lang.footinfo_wx}" alt="微信公众号二维码" style="width: 240px; height: 240px;">
                <else/>
...
@media (max-width: 768px) {
    .qrcode-modal-content { max-width: 90%; padding: 30px 20px; }
    .qrcode-modal-content h3 { margin-bottom: 10px; }
}
</style>
