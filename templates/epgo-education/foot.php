...
<footer class="met-foot">
    <div class="footer-main container">
        <div class="footer-brand">
            <div style="font-size:20px; font-weight:700; color:#fff; margin-bottom:12px;">{$c.met_webname}</div>
            <p>专注剑桥英语备考，KET/PET/FCE全阶段陪伴。每日干货推送，让英语学习不再孤单。</p>
            <if value="$lang['footinfo_wx']">
            <div style="margin-top:16px;">
                <img src="{$lang.footinfo_wx}" alt="公众号二维码" style="width:90px;height:90px;border-radius:8px;vertical-align:middle;">
                <span style="color:rgba(255,255,255,0.6);font-size:13px;margin-left:10px;vertical-align:middle;">{$lang.erweima_one}</span>
            </div>
            </if>
        </div>
